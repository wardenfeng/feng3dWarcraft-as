package me.feng3d.utils
{
	...
	public class War3Utils
	{
		 ...
		 */
		public static function D3DXMatrixTransformation(pScalingCenter:Vector3D, pScalingRotation:Quaternion, pScaling:Vector3D, pRotationCenter:Vector3D, pRotation:Quaternion, pTranslation:Vector3D):Matrix3D
		{
			...
			var matrix3ds:Array = [msc_1, msr_1, ms, msr, msc, mrc_1, mr, mrc, mt];

			var mout:Matrix3D = new Matrix3D();

			for (var i:int = 0; i < matrix3ds.length; i++)
			{
